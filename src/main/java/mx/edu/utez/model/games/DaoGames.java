...
public class DaoGames {
    ...
    public boolean create(BeanGames games, InputStream image){
        ...
        try{
            ...
            InputStream imgGame = null;
            cstm.setBlob(2, (InputStream) null); //marca un error (duda)
    ...
    public boolean update(BeanGames games){
        ...
        try{
            ...
            cstm.setString(2, games.getCategory_idCategory().getName());
            cstm.setString(3, games.getName());
            cstm.setString(4, games.getImgGame());
            cstm.setString(5, games.getDatePremiere());
